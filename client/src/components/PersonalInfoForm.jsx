import { BriefcaseBusiness, Globe, Linkedin, Mail, MapPin, PhoneIcon, User } from 'lucide-react'
...
const PersonalInfoForm = ({data,onChange, removeBackground, setRemoveBackground}) => {
    ...
    const fields = [
        ...
        {key: "phone", label: "Phone Number",icon: PhoneIcon, type: "tel"},
  ...
  return (
    <div>
        ...
        <p className='text-sm text-gray-600' >
            Get Started with the personal information</p>
            ...
            {typeof data.image === 'object' && (
                <div className='flex flex-col gap-1 pl-4 text-sm' >
                    ...
                    <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3' >
                        ...
                        <span className='dot absolute left-1 top-1 w-3 h-3 bg-white rounded-full transition-transform duration-200 ease-in-out
